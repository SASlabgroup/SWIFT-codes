% Run multiple KPP cases from a run table
% 4 8 2026
% Michael James
...
% 
%--------------------------------------------------------------------------
% Utilizes "KPP.m script and a csv table to run through multiple
% user defined cases of PWP with various inputs. 
% Allows for more autonomous running of KPP to cover all cases of interest.
% 
%--------------------------------------------------------------------------
% Table Layout
...
for row =1:height(runs)
    ...
    [KM KT KS ghatu ghatv ghatt ghats hbl D] = kpp(U,V,T,S,ZZ,ZP,WUSURF,WVSURF,WTSURF,WSSURF,SWRD,COR,hbl,r1,amu1,r2,amu2,imod)
