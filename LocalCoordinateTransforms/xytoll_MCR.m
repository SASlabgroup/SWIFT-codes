function [lat, lon] = xytoll_MCR(x,y)
%%Converts an array of local X,Y (meters) relative to an origin in the 
%%Columbia River Mouth (OR/WA)
%% B.Woodward  14 Nov,2008
%% F. Feddersen 3 Mar, 2012
%% D. Honegger 15 May, 2013
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Cape Disappointment lighthouse location (R. Holman, converted to LL via
% sp_proj.m) ... This is just an FYI.
CapeDisappointmentLat = 46.275826;
CapeDisappointmentLon = -124.052134;

% Origin is placed such that the lighthouse coords above are located at 
% (x,y) = (2000 m,2500 m), good to within a fraction of a meter.
OriginLat = 46.253088371866561;
OriginLon = -124.0776468158390;

ZoneNumber = 10;  % UTM Zone Number for MCR
