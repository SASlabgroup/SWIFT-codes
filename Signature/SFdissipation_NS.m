function [eps,qual] = SFdissipation_NS(w,z,zbin,rmin,rmax,nzfit,fittype,avgtype)
% IN PROGRESS!!!!!!!!!!!!!!!

% This function is adapted from SFdissipation by K. Zeiden to data which
% are not stationary in time (i.e. vertically profiling). 
%       
%   in:     w           nbin x nping ensemble of velocity profiles.
%           z           nbin x nping bin depths corresponding to w
%           zbin        vertical bins to compute dissipation within.
