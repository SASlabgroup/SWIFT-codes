...
//
// _coder_despikeSIG_onboard_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "despikeSIG_onboard",                                 // fFunctionName
...
static real_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *nfilt,
                               const char_T *identifier);

static real_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                               const emlrtMsgIdentifier *parentId);

static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *filltype,
                             const char_T *identifier,
                               ...
                               const char_T *identifier)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = emlrt_marshallIn(sp, emlrtAlias(nfilt), &thisId);
  emlrtDestroyArray(&nfilt);
  return y;
}
                             ...
                             coder::array<char_T, 2U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  emlrt_marshallIn(sp, emlrtAlias(filltype), &thisId, y);
  emlrtDestroyArray(&filltype);
}
                            ...
                            const mxArray *plhs[2])
{
  ...
  coder::array<char_T, 2U> filltype;
  ...
  nfilt = emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "nfilt");
  dspikemax = emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "dspikemax");
  emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "filltype", filltype);
  // Invoke the target function
  despikeSIG_onboard(wraw, nfilt, dspikemax, filltype, wclean, ispike);
  // Marshall function outputs
  wclean.no_free();
  plhs[0] = emlrt_marshallOut(wclean);
  if (nlhs > 1) {
    ispike.no_free();
    plhs[1] = b_emlrt_marshallOut(ispike);
  }
...
void despikeSIG_onboard_atexit()
{
  ...
  despikeSIG_onboard_xil_terminate();
  despikeSIG_onboard_xil_shutdown();
...
// End of code generation (_coder_despikeSIG_onboard_api.cpp)
