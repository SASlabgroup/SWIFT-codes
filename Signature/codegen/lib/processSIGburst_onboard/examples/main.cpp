...
void main_processSIGburst_onboard()
{
  ...
  // Call the entry-point 'processSIGburst_onboard'.
  processSIGburst_onboard(wraw, cs_tmp, cs_tmp, cs_tmp, cs_tmp, cs_tmp, cs_tmp,
                          cs_tmp, avgtype_tmp, avgtype_tmp, eps);
}
