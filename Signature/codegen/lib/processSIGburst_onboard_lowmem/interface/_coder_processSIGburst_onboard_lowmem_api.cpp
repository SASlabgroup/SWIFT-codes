...
//
// _coder_processSIGburst_onboard_lowmem_api.cpp
//
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 // fErrorFunction
    "processSIGburst_onboard_lowmem",                     // fFunctionName
    NULL,                                                 // fRTCallStack
    false,                                                // bDebugMode
                                        ...
                                        const mxArray **plhs)
{
  ...
  w.no_free();
  emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_0), "w", w);
  ...
  processSIGburst_onboard_lowmem(w, cs, dz, bz, neoflp, rmin, rmax, nzfit,
                                 avgtype, fittype, eps);
...
void processSIGburst_onboard_lowmem_atexit()
{
  ...
  processSIGburst_onboard_lowmem_xil_terminate();
  processSIGburst_onboard_lowmem_xil_shutdown();
...
// End of code generation (_coder_processSIGburst_onboard_lowmem_api.cpp)
