function fh = plotAQHburst(varargin)
%plotAQHburst plots the data from an aquadopp burst
...
subplot(5,1,2)
imagesc(1:nping,1:nbin,burst.Amp')
title('Amplitude')
...
subplot(5,1,3)
imagesc(1:nping,1:nbin,burst.Cor')
title('Correlation')
cmocean('thermal');caxis([0 100])
set(gca,'YDir','normal')
c = colorbar;c.Label.String = 'C [%]';
ylabel('Bin #')

subplot(5,1,4)
imagesc(1:nping,1:nbin,burst.Vel')
title('Velocity')
