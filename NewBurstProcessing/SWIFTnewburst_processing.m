...
for sn=1:length(SW_list);
    ...
    if length(sigwaveheight_original)>1
        ...
        sigwaveheight=NaN(size(time));
        peakwaveperiod=NaN(size(time));
        peakwavedirT=NaN(size(time));
    end
    ...
    if rmwaves, 
        SWIFT_highres = rmfield(SWIFT_highres,'sigwaveheight'); 
        SWIFT_highres = rmfield(SWIFT_highres,'peakwaveperiod'); 
        SWIFT_highres = rmfield(SWIFT_highres,'peakwavedirT');
    end
