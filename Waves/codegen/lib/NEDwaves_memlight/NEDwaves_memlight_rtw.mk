...
## Generated on : Mon Oct 16 17:02:07 2023
...
SRCS = $(START_DIR)/codegen/lib/NEDwaves_memlight/NEDwaves_memlight_data.c $(START_DIR)/codegen/lib/NEDwaves_memlight/rt_nonfinite.c $(START_DIR)/codegen/lib/NEDwaves_memlight/rtGetNaN.c $(START_DIR)/codegen/lib/NEDwaves_memlight/rtGetInf.c $(START_DIR)/codegen/lib/NEDwaves_memlight/NEDwaves_memlight_initialize.c $(START_DIR)/codegen/lib/NEDwaves_memlight/NEDwaves_memlight_terminate.c $(START_DIR)/codegen/lib/NEDwaves_memlight/NEDwaves_memlight.c $(START_DIR)/codegen/lib/NEDwaves_memlight/colon.c $(START_DIR)/codegen/lib/NEDwaves_memlight/std.c $(START_DIR)/codegen/lib/NEDwaves_memlight/combineVectorElements.c $(START_DIR)/codegen/lib/NEDwaves_memlight/var.c $(START_DIR)/codegen/lib/NEDwaves_memlight/fft.c $(START_DIR)/codegen/lib/NEDwaves_memlight/FFTImplementationCallback.c $(START_DIR)/codegen/lib/NEDwaves_memlight/mean.c $(START_DIR)/codegen/lib/NEDwaves_memlight/minOrMax.c $(START_DIR)/codegen/lib/NEDwaves_memlight/nullAssignment.c $(START_DIR)/codegen/lib/NEDwaves_memlight/div.c $(START_DIR)/codegen/lib/NEDwaves_memlight/NEDwaves_memlight_emxutil.c $(START_DIR)/codegen/lib/NEDwaves_memlight/NEDwaves_memlight_emxAPI.c $(START_DIR)/codegen/lib/NEDwaves_memlight/rtwhalf.c
...
OBJS = NEDwaves_memlight_data.o rt_nonfinite.o rtGetNaN.o rtGetInf.o NEDwaves_memlight_initialize.o NEDwaves_memlight_terminate.o NEDwaves_memlight.o colon.o std.o combineVectorElements.o var.o fft.o FFTImplementationCallback.o mean.o minOrMax.o nullAssignment.o div.o NEDwaves_memlight_emxutil.o NEDwaves_memlight_emxAPI.o rtwhalf.o
...
colon.o : $(START_DIR)/codegen/lib/NEDwaves_memlight/colon.c
	$(CC) $(CFLAGS) -o "$@" "$<"


std.o : $(START_DIR)/codegen/lib/NEDwaves_memlight/std.c
	$(CC) $(CFLAGS) -o "$@" "$<"
