...
for si=1:length(SWIFT)
    ...
    k = (6.28 .* f).^2 ./ 9.8; % deep water dispersion
    
    [Etheta theta f dir spread spread2 spread2alt ] = SWIFTdirectionalspectra(SWIFT(si), 0, 1);
    ...
    SWIFT(si).wavespectra.omega = SWIFT(si).wavespectra.freq + shift;
