...
for ii = 1:length(SWIFT)
    ...
    r1 = sqrt(a1.^2 + b1.^2);% ranges from 0 to 1
    spread1 = rad2deg(sqrt(2*(1-r1)));% directional spread, in degrees
    ...
    for jj=1:length(frequency)
        ...
        if strcmp(depthflag,'intermediate') == 1
            ...
            k = om.^2/9.81;  % BUG: missing k redefinition!
    ...
    % Save computed wave direction and spread
    SWIFT(ii).wavespectra.direction = dir1;
    SWIFT(ii).wavespectra.spread = spread1;
